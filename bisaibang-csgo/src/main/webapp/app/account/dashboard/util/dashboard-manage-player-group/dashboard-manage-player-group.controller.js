...
(function () {
    ...
    DashboardManagePlayerGroupController.$inject = ['$scope', 'adminGetAllPlayersInfo', 'ParseLinks', 'AlertService', 'PaginationUtil', 'paginationConstants', 'DeleteTeam', 'RegisterBatchR', 'UpdateGroup', 'GetRegistrationNoPage', 'GetRegistrationGoupId'];

    function DashboardManagePlayerGroupController($scope, adminGetAllPlayersInfo, ParseLinks, AlertService, PaginationUtil, paginationConstants, DeleteTeam, RegisterBatchR, UpdateGroup, GetRegistrationNoPage, GetRegistrationGoupId) {
        var vm = this;
        vm.page = 1;
        vm.selected = [];
        vm.playerSelected = [];
        ...
        function groupRs() {
            ...
            vm.groupRegistration = [];
            for (var i = 1; i <= groupsNum; i++) {
                GetRegistrationGoupId.get({id:i}, {}, function (result) {
                    console.log(result);
                    vm.groupRegistration.push(result.data);
                }, function () {

                });
            }
            // console.log(vm.groupRegistration);
