...
public final class RandomUtil {
    ...
    public static String getUserDefaultUrl() {
        ...
        if (i < 3) {
            return "https://msone.bisaibang.com/av.jpg";
        } else if (i < 4) {
            return "https://msone.bisaibang.com/av1.jpg";
        } else if (i < 5) {
            return "https://msone.bisaibang.com/av2.jpg";
        } else if (i < 6) {
            return "https://msone.bisaibang.com/av3.jpg";
        } else if (i < 7) {
            return "https://msone.bisaibang.com/av4.jpg";
        } else if (i < 8) {
            return "https://msone.bisaibang.com/av5.jpg";
        } else {
            return "https://msone.bisaibang.com/av6.jpg";
        }
    }
